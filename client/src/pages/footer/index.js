import {Container, SocialMedia, SocialText,SocialIcon,Foot}from './element'
import { FaGooglePlusG,FaFacebookF,FaTwitter,FaInstagram,FaLinkedinIn} from 'react-icons/fa';
const Footer = () => {
    return ( 
    <Container>
        ...
        <Foot>
                copyright &copy; {new Date().getFullYear()} Kihara Nelson
        </Foot>
